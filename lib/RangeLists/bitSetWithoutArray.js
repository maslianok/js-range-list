...
var RangeListBitSetWithoutArray =
/*#__PURE__*/
function () {
  function RangeListBitSetWithoutArray() {
    _classCallCheck(this, RangeListBitSetWithoutArray);
  ...
  _createClass(RangeListBitSetWithoutArray, [{
    key: "add",
    ...
    value: function get() {
      ...
      while (currentBitIdx <= theMostSignificantBitIdx) {
        ...
        if (!currentBitIsSet && prevBitIsSet) {
          result += "[".concat(rangeStartedAt, ", ").concat(currentBitIdx, ")");
        }
  ...
  return RangeListBitSetWithoutArray;
}();

exports["default"] = RangeListBitSetWithoutArray;
